      ...
      <div className={classes["services__details"]}>
        ...
        <div className={classes["services__bullet"]}>
          <div className={classes["services__bullet-icon-box"]}>
            ...
            >
              <path d="M8.05 0.46875C3.76875 0.46875 0.300003 3.96875 0.300003 8.21875C0.300003 12.5 3.76875 15.9688 8.05 15.9688C12.3 15.9688 15.8 12.5 15.8 8.21875C15.8 3.96875 12.3 0.46875 8.05 0.46875ZM10.55 8.21875C10.55 9.625 9.425 10.7188 8.05 10.7188C6.64375 10.7188 5.55 9.625 5.55 8.21875C5.55 6.84375 6.64375 5.71875 8.05 5.71875C9.425 5.71875 10.55 6.84375 10.55 8.21875Z" />
            </svg>
          </div>
